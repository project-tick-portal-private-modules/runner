...
```bash
git clone --recursive https://github.com/flathub/org.projecttick.ProjTLauncher
cd org.projecttick.ProjTLauncher
...
flatpak-builder --user --install flatbuild org.projecttick.ProjTLauncher.yml
```
