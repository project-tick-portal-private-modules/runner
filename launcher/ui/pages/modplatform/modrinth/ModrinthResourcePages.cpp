...
namespace ResourceDownload
{
	...
	ModrinthModPage::ModrinthModPage(ModDownloadDialog* dialog, BaseInstance& instance) : ModPage(dialog, instance)
	{
		...
		connect(m_ui->packView->selectionModel(),
				...
				this,
				&ModrinthModPage::onSelectionChanged);
	...
	{
		m_model = new ResourcePackResourceModel(instance,
												new ModrinthAPI(),
												Modrinth::debugName(),
		...
		connect(m_ui->packView->selectionModel(),
				&QItemSelectionModel::currentChanged,
				this,
				&ModrinthResourcePackPage::onSelectionChanged);
		connect(m_ui->versionSelectionBox,
				&QComboBox::currentIndexChanged,
				this,
		...
		connect(m_ui->resourceSelectionButton,
				&QPushButton::clicked,
				this,
				&ModrinthResourcePackPage::onResourceSelected);
	...
	{
		m_model =
			new TexturePackResourceModel(instance, new ModrinthAPI(), Modrinth::debugName(), Modrinth::metaEntryBase());
		m_ui->packView->setModel(m_model);
		...
		connect(m_ui->packView->selectionModel(),
				&QItemSelectionModel::currentChanged,
				this,
				&ModrinthTexturePackPage::onSelectionChanged);
		connect(m_ui->versionSelectionBox,
				&QComboBox::currentIndexChanged,
				this,
		...
		connect(m_ui->resourceSelectionButton,
				&QPushButton::clicked,
				this,
				&ModrinthTexturePackPage::onResourceSelected);
	...
	{
		m_model =
			new ShaderPackResourceModel(instance, new ModrinthAPI(), Modrinth::debugName(), Modrinth::metaEntryBase());
		m_ui->packView->setModel(m_model);
		...
		connect(m_ui->packView->selectionModel(),
				&QItemSelectionModel::currentChanged,
				this,
				&ModrinthShaderPackPage::onSelectionChanged);
		connect(m_ui->versionSelectionBox,
				&QComboBox::currentIndexChanged,
				this,
		...
		connect(m_ui->resourceSelectionButton,
				&QPushButton::clicked,
				this,
				&ModrinthShaderPackPage::onResourceSelected);
	...
	{
		m_model =
			new DataPackResourceModel(instance, new ModrinthAPI(), Modrinth::debugName(), Modrinth::metaEntryBase());
		m_ui->packView->setModel(m_model);
		...
		connect(m_ui->packView->selectionModel(),
				&QItemSelectionModel::currentChanged,
				this,
				&ModrinthDataPackPage::onSelectionChanged);
		connect(m_ui->versionSelectionBox,
				&QComboBox::currentIndexChanged,
				this,
