...
OptionalModDialog::OptionalModDialog(QWidget* parent, const QStringList& mods)
	: QDialog(parent),
	  ui(new Ui::OptionalModDialog)
{
	ui->setupUi(this);
