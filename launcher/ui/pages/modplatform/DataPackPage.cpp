...
namespace ResourceDownload
{
	...
	DataPackResourcePage::DataPackResourcePage(DataPackDownloadDialog* dialog, BaseInstance& instance)
	...
	void DataPackResourcePage::triggerSearch()
	{
		...
		static_cast<DataPackResourceModel*>(m_model)->searchWithTerm(getSearchTerm(),
