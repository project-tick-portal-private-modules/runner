...
JavaPage::JavaPage(QWidget* parent) : QWidget(parent), ui(new Ui::JavaPage)
{
	...
	{
		ui->managedJavaList->initialize(
			new projt::java::RuntimeCatalog(this, projt::java::RuntimeCatalog::Scope::ManagedOnly));
...
void JavaPage::on_removeJavaButton_clicked()
{
	...
	auto dcast	 = std::dynamic_pointer_cast<projt::java::RuntimeInstall>(version);
	if (!dcast)
	{
		return;
	}
