...
void ThemeManager::initializeWidgets()
{
	...
	themeDebugLog() << "Loading Built-in Theme:"
...
#endif
		themeDebugLog() << "Loading System Theme:"
...
{
	auto catIter =
		m_catPacks.find(!catName.isEmpty() ? catName : APPLICATION->settings()->get("BackgroundCat").toString());
