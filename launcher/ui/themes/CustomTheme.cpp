	...
	if (pathInfo.exists() && pathInfo.isFile())
	{
		try
		{
			...
			if (root.contains("colors"))
			{
				...
				auto readAndSetPaletteColor =
					[this, readColor, colorsRoot](QPalette::ColorRole role, const QString& colorName)
				{
			...
			if (root.contains("logColors"))
			{
				...
				auto readAndSetLogColor =
					[this, readColor, logColorsRoot](MessageLevel::Enum level, bool fg, const QString& colorName)
				{
