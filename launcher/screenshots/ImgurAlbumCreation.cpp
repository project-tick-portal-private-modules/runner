...
Net::NetRequest::Ptr ImgurAlbumCreation::make(std::shared_ptr<ImgurAlbumCreation::Result> output,
											  QList<ScreenShot::Ptr> screenshots)
{
...
QNetworkReply* ImgurAlbumCreation::getReply(QNetworkRequest& request)
{
	...
	const QByteArray data =
		"deletehashes=" + hashes.join(',').toUtf8() + "&title=Minecraft%20Screenshots&privacy=hidden";
