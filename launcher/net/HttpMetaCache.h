...
class MetaEntry
{
  ...
  public:
	...
	auto getRemoteChangedTimestamp() -> QString
	{
		return m_remote_changed_timestamp;
	}
	void setRemoteChangedTimestamp(QString remote_changed_timestamp)
	{
		m_remote_changed_timestamp = remote_changed_timestamp;
	}
	void setLocalChangedTimestamp(qint64 timestamp)
	{
		m_local_changed_timestamp = timestamp;
	}

	auto getETag() -> QString
	{
		return m_etag;
	}
	...
	void makeEternal(bool eternal)
	{
		m_is_eternal = eternal;
	}
	...
	auto getCurrentAge() -> qint64
	{
		return m_current_age;
	}
	void setCurrentAge(qint64 age)
	{
		m_current_age = age;
	}

	auto getMaximumAge() -> qint64
	{
		return m_max_age;
	}
	...
	bool isExpired(qint64 offset)
	{
		return !m_is_eternal && (m_current_age >= m_max_age - offset);
	}
