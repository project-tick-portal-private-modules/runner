...
if command -v "inkscape" && command -v "icotool" && command -v "oxipng"; then
    ...
    svg2png ${LAUNCHER_APPID}.svg "$d/projtlauncher_16.png" 16 16
    svg2png ${LAUNCHER_APPID}.svg "$d/projtlauncher_24.png" 24 24
    svg2png ${LAUNCHER_APPID}.svg "$d/projtlauncher_32.png" 32 32
    svg2png ${LAUNCHER_APPID}.svg "$d/projtlauncher_48.png" 48 48
    svg2png ${LAUNCHER_APPID}.svg "$d/projtlauncher_64.png" 64 64
    svg2png ${LAUNCHER_APPID}.svg "$d/projtlauncher_128.png" 128 128
    svg2png ${LAUNCHER_APPID}.svg "$d/projtlauncher_256.png" 256 256

    oxipng --opt max --strip all --alpha --interlace 0 "$d/projtlauncher_"*".png"

    rm projtlauncher.ico && icotool -o projtlauncher.ico -c \
        "$d/projtlauncher_256.png"  \
        "$d/projtlauncher_128.png"  \
        "$d/projtlauncher_64.png"   \
        "$d/projtlauncher_48.png"   \
        "$d/projtlauncher_32.png"   \
        "$d/projtlauncher_24.png"   \
        "$d/projtlauncher_16.png"
else
