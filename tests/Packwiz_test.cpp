...
class PackwizTest : public QObject
{
  ...
  private slots:
	...
	void loadFromFile_Modrinth()
	{
		...
		QCOMPARE(metadata.url,
				 QUrl("https://cdn.modrinth.com/data/kYq5qkSL/versions/1.1.1+1.18/borderless-mining-1.1.1+1.18.jar"));
		QCOMPARE(metadata.hash_format, "sha512");
		QCOMPARE(metadata.hash,
				 "c8fe6e15ddea32668822dddb26e1851e5f03834be4bcb2eff9c0da7fdc086a9b6cead78e31a44d3bc66335cba11144ee0337c"
				 "6d5346f1ba6362306449"
				 "9b3188d");
	...
	void loadFromFile_Curseforge()
	{
		...
		QCOMPARE(metadata.url,
				 QUrl("https://edge.forgecdn.net/files/3509/43/screenshot-to-clipboard-1.0.7-fabric.jar"));
