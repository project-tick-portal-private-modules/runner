							   ...
							   unsigned flags)
{
	...
	us.filestream = ZOPEN64(us.z_filefunc, file, ZLIB_FILEFUNC_MODE_READ | ZLIB_FILEFUNC_MODE_EXISTING);
...
extern unzFile ZEXPORT unzOpen2(voidpf file, zlib_filefunc_def* pzlib_filefunc32_def)
{
...
extern unzFile ZEXPORT unzOpen2_64(voidpf file, zlib_filefunc64_def* pzlib_filefunc_def)
{
