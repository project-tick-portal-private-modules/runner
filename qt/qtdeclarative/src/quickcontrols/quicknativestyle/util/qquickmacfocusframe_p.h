...
#ifndef QQUICKMACFOCUSFRAME_P_H
#define QQUICKMACFOCUSFRAME_P_H
...
class Q_QUICKNATIVESTYLE_EXPORT QQuickMacFocusFrame : public QQuickFocusFrame
{
    Q_OBJECT
