...
Function .onInit
        ...
        InitPluginsDir
        File /oname=$PLUGINSDIR\splash.bmp "${PTISDIR}\Contrib\Graphics\Header\ptis.bmp"
        #optional
        ...
        File /oname=$PLUGINSDIR\splash.bmp "${PTISDIR}\Contrib\Graphics\Wizard\orange-uninstall.bmp"
        advsplash::show 2000 0 0 0x1856B1 $PLUGINSDIR\splash
        Pop $0 

        MessageBox MB_OK "Transparency/Fading"
        File /oname=$PLUGINSDIR\splash.bmp "${PTISDIR}\Contrib\Graphics\Wizard\llama.bmp"
