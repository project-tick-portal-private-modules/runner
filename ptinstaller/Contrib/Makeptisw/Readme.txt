----------------------------------------------------
MakePTISW - MakePTIS Windows Wrapper
----------------------------------------------------


About MakePTISW
---------------
MakePTISW is a wrapper for the PTIS compiler (MakePTIS).
MakePTISW allows you to compile PTIS scripts using a Windows GUI interface.


Requirements
------------
MakePTISW requires PTIS be installed on your system.  The default 
directory for this installation is $PROGRAMFILES\PTIS\Contrib\MakePTISW.
...
click menu on a PTIS script.  This will invoke MakePTISW.

The format of the parameters when calling MakePTISW from the commandline is:
  makeptisw [options] [script.nsi | - [...]]

For the options, please see the MakePTIS documentation.
...
0.3
 ...
 - No longer uses PTIS's version string
...
0.5
 ...
 - makefiles now target ../../makeptisw.exe
 - removed makeptisw home link in help menu (hope this is ok,
...
0.7
 ...
 - Disable some items when exec of makeptis failed
...
1.9
 ...
 - Makeptisw now takes the same parameters as makeptis.exe
 - Fixed some random crashes
 - Drag and Drop Support into the Makeptisw window
 ...
 - Branding text now reflects PTIS version
 ...
 - Added link to the PTIS Forum under Help menu
...
2.3
- Escape button closes MakePTISw
