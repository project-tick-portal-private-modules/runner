...
// Defines
#define PTIS_URL     "https://ptis.sourceforge.io/"
#define PTIS_FORUM_URL "http://forums.winamp.com/forumdisplay.php?forumid=65"
#define PTIS_UC_URL  "https://ptis.sourceforge.io/update.php?version="
#define PTIS_DL_URL  "https://ptis.sourceforge.io/download/"
#ifdef UNICODE
#define USAGE        _T("Usage:\r\n\r\n \x2022 File \x203a Load Script...\r\n \x2022 Drag the .nsi file into this window\r\n \x2022 Right click the .nsi file and choose \"Compile PTIS Script\"\r\n")
#else
#define USAGE        _T("Usage:\r\n\r\n - File | Load Script...\r\n - Drag the .nsi file into this window\r\n - Right click the .nsi file and choose \"Compile PTIS Script\"\r\n")
#endif
...
#define DONATE       _T("<A>Donate</A> to support PTIS development.")
#define DONATEURL    { 'h'|x,'t','t'|x,'p',':'|x,'/'|x,'/'|x,'n'|x,'s'|x,'i'|x,'s'|x,'.'|x,'s'|x,'f'|x,'.','n'|x,'e'|x,'t'|x,'/'|x,'r','/'|x,'D'|x,'o'|x,'n'|x,'a'|x,'t'|x,'e'|x,'\0' } // "Encrypted"
#define DOCURL       "https://ptis.sourceforge.io/Docs/"
#define LOCALDOCS    _T("\\PTIS.chm")
#define ERRBOXTITLE  0 //_T("Error")
#define PTISERROR    _T("Unable to initialize MakePTIS. Please verify that makeptis.exe is in the same directory as makeptisw.exe.")
#define DLGERROR     _T("Unable to initialize MakePTISW.")
...
#define PTISUPDATEPROMPT _T("Running PTIS Update will close MakePTISW.\nContinue?")
#define REGSEC       HKEY_CURRENT_USER
#define REGSECDEF    HKEY_LOCAL_MACHINE
#define REGKEY       _T("Software\\PTIS")
#define REGLOC       _T("MakePTISWPlacement")
#define REGVERBOSITY _T("MakePTISWVerbosity")
#define REGCOMPRESSOR _T("MakePTISWCompressor")
#define REGCOLORIZE  _T("MakePTISWColorize")
#define REGSYMSUBKEY _T("Symbols")
#define REGMRUSUBKEY _T("MRU")
#define EXENAME      _T("makeptis.exe")
...
#define CLOSEBTN_TIPTEXT _T("Close MakePTISW")

#define WM_MAKEPTIS_PROCESSCOMPLETE (WM_USER+1001)
#define WM_MAKEPTIS_LOADSYMBOLSET (WM_USER+1002)
#define WM_MAKEPTIS_SAVESYMBOLSET (WM_USER+1003)
#define WM_MAKEPTIS_UPDATEUISTATE (WM_USER+1004)
#define WM_MAKEPTIS_FREEZEEDITOR (WM_USER+1005)
...
extern const TCHAR* PTISW_VERSION;
