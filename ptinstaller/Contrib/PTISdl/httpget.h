...
**
** Notes:
**   We used to have a fork of JNetLib in MakePTISw that was slightly different, 
**   you can see it @ http://sf.net/p/ptis/code/6603/tree/PTIS/trunk/Contrib/Makeptisw/jnetlib/
*/
