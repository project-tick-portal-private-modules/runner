/*
  ...
  PTIS plug-in for Type Library Registration/UnRegistration
...
#include <ptis/ptis_tchar.h>

#define PTISFunction(funcname) extern "C" void __declspec(dllexport) funcname(HWND hwndParent, int string_size, TCHAR *variables, stack_t **stacktop)

extern "C" BOOL WINAPI DllMain(HINSTANCE hInst, ULONG ul_reason_for_call, LPVOID lpReserved) {
  return TRUE;
}

PTISFunction(Register) {
