...
echo Deleting...
rd /S vc_mswptis
nmake -f makefile.vc CFG=ptis BUILD=release RUNTIME_LIBS=static SHARED=0 UNICODE=0 WXUNIV=0 USE_OPENGL=0 USE_ODBC=0 USE_HTML=1 USE_XRC=0
if "%1"=="" goto unicode
...
echo Deleting...
rd /S vc_mswuuptis
nmake -f makefile.vc CFG=uptis BUILD=release RUNTIME_LIBS=static SHARED=0 UNICODE=1 WXUNIV=0 USE_OPENGL=0 USE_ODBC=0 USE_HTML=1 USE_XRC=0
