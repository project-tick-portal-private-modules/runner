...
PTIS Modern User Interface - Version 1.81
...
!verbose pop
!echo "PTIS Modern User Interface version ${MUI_SYSVERSION} - Copyright 2002-2025 Joost Verburg"
...
!macro MUI_INTERFACE
  ...
  !ifndef MUI_INTERFACE
    ...
    !ifdef MUI_INSERT_PTISCONF
      !insertmacro MUI_PTISCONF
    !endif

    !insertmacro MUI_DEFAULT MUI_UI "${PTISDIR}\Contrib\UIs\modern.exe"
    !insertmacro MUI_DEFAULT MUI_UI_HEADERIMAGE "${PTISDIR}\Contrib\UIs\modern_headerbmp.exe"
    !insertmacro MUI_DEFAULT MUI_UI_HEADERIMAGE_RIGHT "${PTISDIR}\Contrib\UIs\modern_headerbmpr.exe"
    !insertmacro MUI_DEFAULT MUI_UI_COMPONENTSPAGE_SMALLDESC "${PTISDIR}\Contrib\UIs\modern_smalldesc.exe"
    !insertmacro MUI_DEFAULT MUI_UI_COMPONENTSPAGE_NODESC "${PTISDIR}\Contrib\UIs\modern_nodesc.exe"
    !insertmacro MUI_DEFAULT MUI_ICON "${PTISDIR}\Contrib\Graphics\Icons\modern-install.ico"
    !insertmacro MUI_DEFAULT MUI_UNICON "${PTISDIR}\Contrib\Graphics\Icons\modern-uninstall.ico"
    !insertmacro MUI_DEFAULT MUI_COMPONENTSPAGE_CHECKBITMAP "${PTISDIR}\Contrib\Graphics\Checks\modern.bmp"
    ...
    !insertmacro MUI_DEFAULT MUI_WELCOMEFINISHPAGE_INI "${PTISDIR}\Contrib\Modern UI\ioSpecial.ini"
    !insertmacro MUI_DEFAULT MUI_UNWELCOMEFINISHPAGE_INI "${PTISDIR}\Contrib\Modern UI\ioSpecial.ini"
    !insertmacro MUI_DEFAULT MUI_WELCOMEFINISHPAGE_BITMAP "${PTISDIR}\Contrib\Graphics\Wizard\win.bmp"
    !insertmacro MUI_DEFAULT MUI_UNWELCOMEFINISHPAGE_BITMAP "${PTISDIR}\Contrib\Graphics\Wizard\win.bmp"
    ...
    !ifdef MUI_HEADERIMAGE
      ...
      !insertmacro MUI_DEFAULT MUI_HEADERIMAGE_BITMAP "${PTISDIR}\Contrib\Graphics\Header\ptis.bmp"
...
!macro MUI_INSTALLOPTIONS_WRITE_DEFAULTCONVERT FILE SECTION KEY SYMBOL
  ...
  !else
    Push "${${SYMBOL}}"
    Call ${MUI_PAGE_UNINSTALLER_FUNCPREFIX}Ptis2Io
    Pop $MUI_TEMP1
...
!macro MUI_LANGUAGE NLFID
  ...
  LoadLanguageFile "${PTISDIR}\Contrib\Language files\${NLFID}.nlf"

  ;Include language file
  !insertmacro LANGFILE_INCLUDE_WITHDEFAULT \
    "${PTISDIR}\Contrib\Language files\${NLFID}.nsh" "${PTISDIR}\Contrib\Language files\English.nsh"
