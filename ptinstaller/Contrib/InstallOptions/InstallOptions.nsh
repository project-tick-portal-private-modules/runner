...
!ifndef ___PTIS__INSTALL_OPTIONS__NSH___
!define ___PTIS__INSTALL_OPTIONS__NSH___

!include LogicLib.nsh

!macro INSTALLOPTIONS_FUNCTION_READ_CONVERT
  !insertmacro INSTALLOPTIONS_FUNCTION_IO2PTIS ""
!macroend

!macro INSTALLOPTIONS_UNFUNCTION_READ_CONVERT
  !insertmacro INSTALLOPTIONS_FUNCTION_IO2PTIS un.
!macroend

!macro INSTALLOPTIONS_FUNCTION_WRITE_CONVERT
  !insertmacro INSTALLOPTIONS_FUNCTION_PTIS2IO ""
!macroend

!macro INSTALLOPTIONS_UNFUNCTION_WRITE_CONVERT
  !insertmacro INSTALLOPTIONS_FUNCTION_PTIS2IO un.
!macroend

!macro INSTALLOPTIONS_FUNCTION_PTIS2IO UNINSTALLER_FUNCPREFIX

  ; Convert an PTIS string to a form suitable for use by InstallOptions
  ; Usage:
  ;   Push <PTIS-string>
  ;   Call Ptis2Io
  ;   Pop <IO-string>

  Function ${UNINSTALLER_FUNCPREFIX}Ptis2Io
...
!macro INSTALLOPTIONS_FUNCTION_IO2PTIS UNINSTALLER_FUNCPREFIX

  ; Convert an InstallOptions string to a form suitable for use by PTIS
  ; Usage:
  ;   Push <IO-string>
  ;   Call Io2Ptis
  ;   Pop <PTIS-string>

  Function ${UNINSTALLER_FUNCPREFIX}Io2Ptis
...
!endif # ___PTIS__INSTALL_OPTIONS__NSH___
