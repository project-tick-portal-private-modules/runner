...
ReserveFile "${PTISDIR}\Contrib\Graphics\Checks\colorful.bmp"
ReserveFile "${PTISDIR}\Contrib\Graphics\Checks\modern.bmp"
ReserveFile "${PTISDIR}\Contrib\Graphics\Icons\pixel-install.ico"
...
Function .onInit
  ...
  File /oname=$PLUGINSDIR\image.bmp "${PTISDIR}\Contrib\Graphics\Checks\colorful.bmp"
  File /oname=$PLUGINSDIR\image2.bmp "${PTISDIR}\Contrib\Graphics\Checks\modern.bmp"
  File /oname=$PLUGINSDIR\icon.ico "${PTISDIR}\Contrib\Graphics\Icons\pixel-install.ico"
