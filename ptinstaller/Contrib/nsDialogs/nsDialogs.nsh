...
!define __NSD_RichEdit_CLASS_20A "RICHEDIT20A" ; 2.0 (Riched20.dll) Win98/NT4 (PTIS makes sure this is registered even on Windows 95)
...
!macro __NSD_GetText CONTROL VAR
	System::Call user32::GetWindowText(p${CONTROL},t.s,i${PTIS_MAX_STRLEN})
	Pop ${VAR}
!macroend
...
!macro __NSD_Edit_GetLine CONTROL LINEINDEX OUTPUT
	System::Call '*(&i2 ${PTIS_MAX_STRLEN},&t${PTIS_MAX_STRLEN})p.s'
	System::Call 'USER32::SendMessage(p${CONTROL},i${EM_GETLINE},p${LINEINDEX},pss)'
	System::Call 'KERNEL32::lstrcpyn(t.s,pss,i${PTIS_MAX_STRLEN})'
	Pop ${OUTPUT}
	System::Free
!macroend
