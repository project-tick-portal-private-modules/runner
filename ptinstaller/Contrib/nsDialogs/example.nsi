...
Function OnChange
	...
	System::Call user32::GetWindowText(p$EDIT,t.r0,i${PTIS_MAX_STRLEN})
	${If} $0 == "hello there"
...
Function NotifyPage
	...
	${NSD_SetText} $9 "{\rtf1\ansi{\fonttbl\f0\fswiss Helvetica;}\f0\pard http://ptis.sf.net\par {\b Click the link!}\par\par Type something and I will block every other character...}"
