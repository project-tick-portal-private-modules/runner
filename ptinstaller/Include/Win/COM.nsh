...
${If} $0 P<> 0
	...
	${AndIf} $2 = 0
		...
		${If} $1 P<> 0
			${IPersistFile::Save} $1 '("$SMPrograms\ptis_test.lnk",1)'
			${IUnknown::Release} $1 ""
		${EndIf}
	${EndIf}
	${IUnknown::Release} $0 ""
...
!define __WIN_COM__INC ${PTIS_CHAR_SIZE}
!verbose push
!verbose 3
...
!define PTISCOMCALL "!insertmacro PTISCOMCALL "
!macro PTISCOMCALL vtblidx decl ptr params
!if ${PTIS_CHAR_SIZE} <> ${__WIN_COM__INC}
; Warn if QueryInterface() for IID_IShellLink etc will return the wrong interface
!warning "PTIS_CHAR_SIZE changed, existing defines and macros might not work correctly!"
!endif
System::Call `${ptr}->${vtblidx}${decl}${params}`
!macroend
!define PTISCOMIFACEDECL "!insertmacro PTISCOMIFACEDECL "
!macro PTISCOMIFACEDECL iface method vtblidx decl
!define ${iface}::${method} `${PTISCOMCALL} ${vtblidx} ${decl} `
!macroend
...
${PTISCOMIFACEDECL}IUnknown QueryInterface 0 (g,*p)i
${PTISCOMIFACEDECL}IUnknown AddRef 1 ()i
${PTISCOMIFACEDECL}IUnknown Release 2 ()i
!endif

!ifndef IID_IPersist
!define IID_IPersist {0000010c-0000-0000-C000-000000000046}
${PTISCOMIFACEDECL}IPersist GetClassID 3 (g)i
!endif

!ifndef IID_IPersistStream
!define IID_IPersistStream {00000109-0000-0000-C000-000000000046} ; IPersist>
${PTISCOMIFACEDECL}IPersistStream IsDirty 4 ()i
${PTISCOMIFACEDECL}IPersistStream Load 5 (p,i)i
${PTISCOMIFACEDECL}IPersistStream Save 6 (p,i)i
${PTISCOMIFACEDECL}IPersistStream GetSizeMax 7 (*l)i
!endif
!ifndef IID_IPersistStreamInit
!define IID_IPersistStreamInit {7FD52380-4E07-101B-AE2D-08002B2EC713} ; IPersist>
${PTISCOMIFACEDECL}IPersistStreamInit IsDirty 4 ()i
${PTISCOMIFACEDECL}IPersistStreamInit Load 5 (p,i)i
${PTISCOMIFACEDECL}IPersistStreamInit Save 6 (p,i)i
${PTISCOMIFACEDECL}IPersistStreamInit GetSizeMax 7 (*l)i
${PTISCOMIFACEDECL}IPersistStreamInit InitNew 8 ()i
!endif

!ifndef IID_IPersistFile
!define IID_IPersistFile {0000010b-0000-0000-C000-000000000046} ; IPersist>
${PTISCOMIFACEDECL}IPersistFile IsDirty 4 ()i
${PTISCOMIFACEDECL}IPersistFile Load 5 (w,i)i
${PTISCOMIFACEDECL}IPersistFile Save 6 (w,i)i
${PTISCOMIFACEDECL}IPersistFile SaveCompleted 7 (w)i
${PTISCOMIFACEDECL}IPersistFile GetCurFile 8 (*w)i
!endif
...
!endif
${PTISCOMIFACEDECL}IShellLink GetPath 3 (t,i,p,i)i
${PTISCOMIFACEDECL}IShellLink GetIDList 4 (*p)i
${PTISCOMIFACEDECL}IShellLink SetIDList 5 (p)i
${PTISCOMIFACEDECL}IShellLink GetDescription 6 (t,i)i
${PTISCOMIFACEDECL}IShellLink SetDescription 7 (t)i
${PTISCOMIFACEDECL}IShellLink GetWorkingDirectory 8 (t,i)i
${PTISCOMIFACEDECL}IShellLink SetWorkingDirectory 9 (t)i
${PTISCOMIFACEDECL}IShellLink GetArguments 10 (t,i)i
${PTISCOMIFACEDECL}IShellLink SetArguments 11 (t)i
${PTISCOMIFACEDECL}IShellLink GetHotkey 12 (*i0)i
${PTISCOMIFACEDECL}IShellLink SetHotkey 13 (&i2)i
${PTISCOMIFACEDECL}IShellLink GetShowCmd 14 (*i)i
${PTISCOMIFACEDECL}IShellLink SetShowCmd 15 (i)i
${PTISCOMIFACEDECL}IShellLink GetIconLocation 16 (t,i,*i)i
${PTISCOMIFACEDECL}IShellLink SetIconLocation 17 (t,i)i
${PTISCOMIFACEDECL}IShellLink SetRelativePath 18 (t,i)i
${PTISCOMIFACEDECL}IShellLink Resolve 19 (p,i)i
${PTISCOMIFACEDECL}IShellLink SetPath 20 (t)i
!endif

!ifndef IID_IShellLinkDataList
!define IID_IShellLinkDataList {45e2b4ae-b1c3-11d0-b92f-00a0c90312e1}
${PTISCOMIFACEDECL}IShellLinkDataList AddDataBlock 3 (p)i
${PTISCOMIFACEDECL}IShellLinkDataList CopyDataBlock 4 (i,*p)i
${PTISCOMIFACEDECL}IShellLinkDataList RemoveDataBlock 5 (i)i
${PTISCOMIFACEDECL}IShellLinkDataList GetFlags 6 (*i)i
${PTISCOMIFACEDECL}IShellLinkDataList SetFlags 7 (i)i
!endif
...
${PTISCOMIFACEDECL}IShellItem BindToHandler 3 (p,g,g,*p)i
${PTISCOMIFACEDECL}IShellItem GetParent 4 (*p)i
${PTISCOMIFACEDECL}IShellItem GetDisplayName 5 (i,*p)i
${PTISCOMIFACEDECL}IShellItem GetAttributes 6 (i,*i)i
${PTISCOMIFACEDECL}IShellItem Compare 7 (p,i,*i)i
!endif
...
${PTISCOMIFACEDECL}IStartMenuPinnedList RemoveFromList 3 (p)i
!endif
...
${PTISCOMIFACEDECL}IApplicationDestinations SetAppID 3 (w)i
${PTISCOMIFACEDECL}IApplicationDestinations RemoveDestination 4 (p)i ; IShellItem or IShellLink 
${PTISCOMIFACEDECL}IApplicationDestinations RemoveAllDestinations 5 ()i
!endif
...
${PTISCOMIFACEDECL}ICustomDestinationList SetAppID 3 (w)i
${PTISCOMIFACEDECL}ICustomDestinationList BeginList 4 (*i,g,*p)i ; IObjectArray or IEnumObjects
${PTISCOMIFACEDECL}ICustomDestinationList AppendCategory 5 (w,p)i ; IObjectArray*
${PTISCOMIFACEDECL}ICustomDestinationList AppendKnownCategory 6 (i)i
${PTISCOMIFACEDECL}ICustomDestinationList AddUserTasks 7 (p)i ; IObjectArray*
${PTISCOMIFACEDECL}ICustomDestinationList CommitList 8 ()i
${PTISCOMIFACEDECL}ICustomDestinationList GetRemovedDestinations 9 (g,*p)i ; IObjectCollection
${PTISCOMIFACEDECL}ICustomDestinationList DeleteList 10 (w)i
${PTISCOMIFACEDECL}ICustomDestinationList AbortList 11 ()i
!endif
...
${PTISCOMIFACEDECL}IObjectArray GetCount 3 (*i)i
${PTISCOMIFACEDECL}IObjectArray GetAt 4 (i,g,*p)i
!endif

!ifndef IID_IObjectCollection
!define IID_IObjectCollection {5632b1a4-e38a-400a-928a-d4cd63230295} ; IObjectArray>
${PTISCOMIFACEDECL}IObjectCollection AddObject 5 (p)i ; IUnknown*
${PTISCOMIFACEDECL}IObjectCollection AddFromArray 6 (p)i ; IObjectArray*
${PTISCOMIFACEDECL}IObjectCollection RemoveObjectAt 7 (i)i
${PTISCOMIFACEDECL}IObjectCollection Clear 8 ()i
!endif

!ifndef IID_IEnumObjects
!define IID_IEnumObjects {2c1c7e2e-2d0e-4059-831e-1e6f82335c2e}
${PTISCOMIFACEDECL}IEnumObjects Next 3 (i,g,*p,*i)i
${PTISCOMIFACEDECL}IEnumObjects Skip 4 (i)i
${PTISCOMIFACEDECL}IEnumObjects Reset 5 ()i
${PTISCOMIFACEDECL}IEnumObjects Clone 6 (*p)i
!endif

!ifndef IID_IEnumUnknown
!define IID_IEnumUnknown {00000100-0000-0000-C000-000000000046}
${PTISCOMIFACEDECL}IEnumUnknown Next 3 (i,*p,*i)i
${PTISCOMIFACEDECL}IEnumUnknown Skip 4 (i)i
${PTISCOMIFACEDECL}IEnumUnknown Reset 5 ()i
${PTISCOMIFACEDECL}IEnumUnknown Clone 6 (*p)i
!endif

!ifndef IID_IPropertyStore
!define IID_IPropertyStore {886D8EEB-8CF2-4446-8D02-CDBA1DBDCF99}
${PTISCOMIFACEDECL}IPropertyStore GetCount 3 (*i)i
${PTISCOMIFACEDECL}IPropertyStore GetAt 4 (i,p)i
${PTISCOMIFACEDECL}IPropertyStore GetValue 5 (p,p)i
${PTISCOMIFACEDECL}IPropertyStore SetValue 6 (p,p)i
${PTISCOMIFACEDECL}IPropertyStore Commit 7 ()i
!endif

!ifndef IID_IPropertyStorage
!define IID_IPropertyStorage {00000138-0000-0000-C000-000000000046}
${PTISCOMIFACEDECL}IPropertyStorage ReadMultiple 3 (i,p,p)i
${PTISCOMIFACEDECL}IPropertyStorage WriteMultiple 4 (i,p,p,i)i
${PTISCOMIFACEDECL}IPropertyStorage DeleteMultiple 5 (i,p)i
${PTISCOMIFACEDECL}IPropertyStorage ReadPropertyNames 6 (p,p)i
...
${PTISCOMIFACEDECL}IPropertyStorage SetTimes 12 (p,p,p)i
${PTISCOMIFACEDECL}IPropertyStorage SetClass 13 (g)i
${PTISCOMIFACEDECL}IPropertyStorage Stat 14 (p)i
!endif

!ifndef IID_IPropertySetStorage
!define IID_IPropertySetStorage {0000013A-0000-0000-C000-000000000046}
${PTISCOMIFACEDECL}IPropertySetStorage Create 3 (g,g,i,i,*p)i
${PTISCOMIFACEDECL}IPropertySetStorage Open 4 (g,i,*p)i
${PTISCOMIFACEDECL}IPropertySetStorage Delete 5 (g)i
${PTISCOMIFACEDECL}IPropertySetStorage Enum 6 (*p)i
!endif
...
${PTISCOMIFACEDECL}IApplicationAssociationRegistration QueryCurrentDefault 3 (w,i,i,*p)i
${PTISCOMIFACEDECL}IApplicationAssociationRegistration QueryAppIsDefault 4 (w,i,i,w,*i)i
${PTISCOMIFACEDECL}IApplicationAssociationRegistration QueryAppIsDefaultAll 5 (i,w,*i)i
${PTISCOMIFACEDECL}IApplicationAssociationRegistration SetAppAsDefault 6 (w,w,i)i
${PTISCOMIFACEDECL}IApplicationAssociationRegistration SetAppAsDefaultAll 7 (w)i
${PTISCOMIFACEDECL}IApplicationAssociationRegistration ClearUserAssociations 8 ()i
!endif
...
${PTISCOMIFACEDECL}IApplicationAssociationRegistrationUI LaunchAdvancedAssociationUI 3 (w)i
!endif
...
${PTISCOMIFACEDECL}IGameExplorer AddGame 3 (p,p,i,g)i
${PTISCOMIFACEDECL}IGameExplorer RemoveGame 4 (i,i,i,i)i ; The parameter is a GUID, not REFGUID so the 'g' type cannot be used!
${PTISCOMIFACEDECL}IGameExplorer UpdateGame 5 (i,i,i,i)i
${PTISCOMIFACEDECL}IGameExplorer VerifyAccess 6 (p,*i)i
!endif
...
${PTISCOMIFACEDECL}IGameExplorer2 InstallGame 3 (w,w,i)i
${PTISCOMIFACEDECL}IGameExplorer2 UninstallGame 4 (w)i
${PTISCOMIFACEDECL}IGameExplorer2 CheckAccess 5 (w,*i)i
!endif
...
${PTISCOMIFACEDECL}IGameStatisticsMgr GetGameStatistics 3 (w,i,*i,*p)i
${PTISCOMIFACEDECL}IGameStatisticsMgr RemoveGameStatistics 4 (w)i
!endif
...
!endif
${PTISCOMIFACEDECL}IUniformResourceLocator SetURL 3 (t,i)i
${PTISCOMIFACEDECL}IUniformResourceLocator GetURL 4 (*p)i
${PTISCOMIFACEDECL}IUniformResourceLocator InvokeCommand 5 (p)i
!endif
