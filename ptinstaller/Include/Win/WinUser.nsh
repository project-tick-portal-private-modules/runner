...
!define /math DWLP_DLGPROC ${DWLP_MSGRESULT} + ${PTIS_PTR_SIZE} ;DWLP_MSGRESULT + sizeof(LRESULT) 
!define /math DWLP_USER    ${DWLP_DLGPROC} + ${PTIS_PTR_SIZE} ;DWLP_DLGPROC + sizeof(DLGPROC)
!endif
