...
* There are two types of language header files:
  ...
  - PTIS multi-lang support; these must start with the LANGFILE macro and 
    provide strings for features like MUI and MultiUser. If you are adding 
    support for a new language to PTIS you should make a copy of English.nsh 
...
!macro LANGFILE NLFID ENGNAME NATIVENAME NATIVEASCIINAME
  ...
  ;Start of standard PTIS language file
