; PTIS LOGIC LIBRARY - LogicLib.nsh
...
;
; Description:
;   Provides the use of various logic statements within PTIS.
;
; Usage:
...
;           value of the provided PTIS function.
...
;       Built-in PTIS flag tests:
;         ${Abort}; ${Errors}; ${RebootFlag}; ${Silent}; ${RtlLanguage};
;         ${ShellVarContextAll}
;       Built-in PTIS other tests:
;         ${FileExists} a
;       Any conditional PTIS instruction test:
;         ${Cmd} a
;       Section flag tests:
