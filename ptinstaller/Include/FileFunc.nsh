...
!macro GetDrives_
	...
	IntOp $4 $4 * ${PTIS_CHAR_SIZE}
	IntOp $3 $3 + $4
	IntOp $3 $3 + ${PTIS_CHAR_SIZE}
...
!macro GetExeName_
	...
	Push $1
	Push $2
	System::Call 'kernel32::GetModuleFileName(p 0, t.r0, i ${PTIS_MAX_STRLEN})'
	System::Call 'kernel32::GetLongPathName(t r0, t.r1, i ${PTIS_MAX_STRLEN})i.r2'
	StrCmp $2 error +2
	StrCpy $0 $1
	Pop $2
	Pop $1
