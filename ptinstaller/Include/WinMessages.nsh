...
!define _PTIS_DEFAW '!insertmacro _PTIS_DEFAW '
!macro _PTIS_DEFAW d
!ifdef PTIS_UNICODE
!define ${d} "${${d}W}"
!else
...
!define SYSSTRUCT_LVITEM_V1 (i,i,i,i,&i${PTIS_PTR_SIZE},t,i,i,p)
!define SYSSTRUCT_LVITEM_V2 (i,i,i,i,&i${PTIS_PTR_SIZE},t,i,i,p,i)           ; IE3
!define SYSSTRUCT_LVITEM_V3 (i,i,i,i,&i${PTIS_PTR_SIZE},t,i,i,p,i,i,i,i)     ; WinXP + ComCtl32 v6
!define SYSSTRUCT_LVITEM_V4 (i,i,i,i,&i${PTIS_PTR_SIZE},t,i,i,p,i,i,i,i,i,i) ; WinVista + ComCtl32 v6
...
${_PTIS_DEFAW} LVM_GETITEM
${_PTIS_DEFAW} LVM_SETITEM
${_PTIS_DEFAW} LVM_INSERTITEM
${_PTIS_DEFAW} LVM_INSERTCOLUMN
${_PTIS_DEFAW} LVM_GETITEMTEXT
${_PTIS_DEFAW} LVM_SETITEMTEXT
...
!define TCIF_TEXT  1
!define TCIF_PARAM 8
!define SYSSTRUCT_TCITEM (i,i,&i${PTIS_PTR_SIZE},t,i,i,p)
