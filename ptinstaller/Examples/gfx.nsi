...
; graphic related additions introduced in PTIS 2
;
...
Section ""
	...
	MessageBox MB_YESNO "We can change the branding image from within a section too!$\nDo you want me to change it?" IDNO done
		!insertmacro BIMAGE "${PTISDIR}\Contrib\Graphics\Wizard\ptis.bmp" ""
	done:
...
Function licenseImage
	!insertmacro BIMAGE "${PTISDIR}\Contrib\Graphics\Header\ptis.bmp" /RESIZETOFIT
...
Function customPage
	!insertmacro BIMAGE "${PTISDIR}\Contrib\Graphics\Checks\modern.bmp" /RESIZETOFIT
...
Function dirImage
	!insertmacro BIMAGE "${PTISDIR}\Contrib\Graphics\Header\win.bmp" /RESIZETOFIT
FunctionEnd

Function instImage
	!insertmacro BIMAGE "${PTISDIR}\Contrib\Graphics\Wizard\llama.bmp" /RESIZETOFIT
FunctionEnd
