...
SetCompressor LZMA
ChangeUI IDD_INST "${PTISDIR}\Contrib\UIs\modern_headerbmp.exe"
Icon "${PTISDIR}\Contrib\Graphics\Icons\ptis-menu.ico"
BrandingText " "
MiscButtonText " " " " " " " "
InstallButtonText " "
CompletedText " "
...
!ifdef PTIS_PACKEDVERSION
!insertmacro UNPACKVERFIELD VER_MAJOR ${PTIS_PACKEDVERSION} 24 0x0ff "%X"
!insertmacro UNPACKVERFIELD VER_MINOR ${PTIS_PACKEDVERSION} 12 0xfff "%X"
!insertmacro UNPACKVERFIELD VER_REVISION ${PTIS_PACKEDVERSION} 4 255 "%X"
!insertmacro UNPACKVERFIELD VER_BUILD ${PTIS_PACKEDVERSION} 00 0x00f "%X"
!endif
!endif
!ifdef VER_MAJOR & VER_MINOR
!define /ifndef VER_REVISION 0
!define /ifndef VER_BUILD 0
!searchreplace VERSTR "${PTIS_VERSION}" "v" ""
VIProductVersion ${VER_MAJOR}.${VER_MINOR}.${VER_REVISION}.${VER_BUILD}
VIAddVersionKey "ProductName" "PTIS"
VIAddVersionKey "ProductVersion" "${VERSTR}"
VIAddVersionKey "FileVersion" "${VERSTR}"
VIAddVersionKey "FileDescription" "PTIS Menu"
...
Function .onGUIInit
ReadRegDWORD $UseLightTheme HKCU "Software\PTIS" "UseLightTheme"
...
!insertmacro CreateSimpleLink "Compile NSI scripts" "${PR}\MakePTISW" ${UX_W}
...
!insertmacro CreateControl Label "Many more examples, tutorials, plug-ins and PTIS-related software are available at the online Developer Center." ${UX_W} ${UY_MULTILINE}
Pop $0
...
!insertmacro CreateSimpleLink "PTIS Users Manual" "${PR}\PTIS.chm|${WWW}/Docs/" ${UX_W}
...
!insertmacro CreateSimpleLink "Stackoverflow" "http://stackoverflow.com/questions/tagged/ptis" ${UX_W}
!insertmacro CreateSimpleLink "Chat" "${WWW}/r/Chat" ${UX_W}
;insertmacro CreateSimpleLink "IRC channel" "irc://irc.landoleet.org/ptis" ${UX_W}
;"Pastebin" "http://ptis.pastebin.com/index/1FtyKP89"
...
!insertmacro CreatePluginLink "PTISdl"    "download files"              "${PD}\PTISdl\Readme.txt"
...
nsDialogs::CreateControl ${__NSD_Label_CLASS} ${__NSD_Label_STYLE}|${SS_CENTERIMAGE}|${SS_NOTIFY} ${__NSD_Label_EXSTYLE} -110u -20u 100% 20u "ptis.sourceforge.net"
Pop $0
${SetCtlColors} $0 ${CT_FOOTER} transparent transparent
SendMessage $0 ${WM_SETFONT} ${HF_HEADER} 1
nsDialogs::SetUserData $0 "https://ptis.sourceforge.io"
