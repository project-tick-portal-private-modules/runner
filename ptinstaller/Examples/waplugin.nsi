...
!endif
  ...
  File /oname=vis_nsfs.dll "${PTISDIR}\Plugins\x86-ansi\TypeLib.dll" # dummy plug-in
...
Function MakeSureIGotWinamp
  ...
  PTISdl::download http://download.nullsoft.com/winamp/client/winamp281_lite.exe $2
  Pop $0
