...
; First is default
LoadLanguageFile "${PTISDIR}\Contrib\Language files\English.nlf"
LoadLanguageFile "${PTISDIR}\Contrib\Language files\Czech.nlf"
LoadLanguageFile "${PTISDIR}\Contrib\Language files\Dutch.nlf"
LoadLanguageFile "${PTISDIR}\Contrib\Language files\French.nlf"
LoadLanguageFile "${PTISDIR}\Contrib\Language files\German.nlf"
LoadLanguageFile "${PTISDIR}\Contrib\Language files\Korean.nlf"
LoadLanguageFile "${PTISDIR}\Contrib\Language files\Russian.nlf"
LoadLanguageFile "${PTISDIR}\Contrib\Language files\Spanish.nlf"
LoadLanguageFile "${PTISDIR}\Contrib\Language files\Swedish.nlf"
LoadLanguageFile "${PTISDIR}\Contrib\Language files\TradChinese.nlf"
LoadLanguageFile "${PTISDIR}\Contrib\Language files\SimpChinese.nlf"
LoadLanguageFile "${PTISDIR}\Contrib\Language files\Slovak.nlf"
...
LicenseLangString myLicenseData ${LANG_SWEDISH} "makeptis.nsi"
