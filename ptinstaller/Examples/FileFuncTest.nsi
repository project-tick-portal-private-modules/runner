...
Section GetRoot
	...
	${GetRoot} 'C:\Program Files\PTIS' $OUT1
	StrCmp $OUT1 'C:' 0 error

	${GetRoot} '\\SuperPimp\PTIS\Source\exehead\Ui.c' $OUT1
	StrCmp $OUT1 '\\SuperPimp\PTIS' 0 error

	${GetRoot} '\\Program Files\PTIS' $OUT1
	StrCmp $OUT1 '\\Program Files\PTIS' 0 error

	${GetRoot} '\\Program Files\PTIS\' $OUT1
	StrCmp $OUT1 '\\Program Files\PTIS' 0 error

	${GetRoot} '\\Program Files\PTIS\Source\exehead\Ui.c' $OUT1
	StrCmp $OUT1 '\\Program Files\PTIS' 0 error
