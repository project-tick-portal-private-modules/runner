;------------------------
;DEFAULT PTIS CONFIG FILE
;------------------------

;This header file will be included when compiling any PTIS installer,
...
;UninstallIcon "${PTISDIR}\Contrib\Graphics\Icons\arrow-uninstall.ico"
...
;The Modern UI will insert the MUI_PTISCONF macro just before processing the settings.
;Here you can set default settings for the Modern UI.

;------------------------

!define MUI_INSERT_PTISCONF
...
!macro MUI_PTISCONF
  ...
  ;  !define MUI_ICON "${PTISDIR}\Contrib\Graphics\Icons\arrow-install.ico"
  ;  !define MUI_UNICON "${PTISDIR}\Contrib\Graphics\Icons\arrow-uninstall.ico"
  ;!endif
