...
void PTISCALL Plugins_SendMsgToAllPlugins(int msg)
{
  loaded_plugin* p;
...
void PTISCALL Plugins_UnloadAll() 
{
...
BOOL PTISCALL Plugins_CanUnload(HANDLE pluginHandle)
{
  loaded_plugin* p;
...
int PTISCALL RegisterPluginCallback(HMODULE pluginHandle, PTISPLUGINCALLBACK proc)
{
  loaded_plugin* p;
