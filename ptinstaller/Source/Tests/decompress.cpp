...
#define EXEHEAD
#define PTIS_CONFIG_COMPRESSION_SUPPORT

#include "../Platform.h"

extern "C" {
#define PTIS_COMPRESS_USE_BZIP2
#include "../bzip2/bzlib.h"
#undef PTIS_COMPRESS_USE_BZIP2

#define PTIS_COMPRESS_USE_LZMA
#include "../7zip/LZMADecode.h"
#undef PTIS_COMPRESS_USE_LZMA

#define PTIS_COMPRESS_USE_ZLIB
#include "../zlib/ZLIB.H"
#undef PTIS_COMPRESS_USE_ZLIB
}
