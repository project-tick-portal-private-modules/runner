...
#endif //~ PTIS_CONFIG_ENHANCEDUI_SUPPORT
...
#ifdef PTIS_SUPPORT_STANDARD_PREDEFINES
...
{
  ExpandoString<TCHAR, PTIS_MAX_STRLEN> buf;
...
#ifdef PTIS_FIX_DEFINES_IN_STRINGS
...
int CEXEBuild::doCommand(int which_token, LineParser &line)
{
  ...
  switch (which_token)
  {
...
#ifndef PTIS_SUPPORT_CODECALLBACKS
        if (!k) {
          ERROR_MSG(_T("Error: custom page specified, PTIS_SUPPORT_CODECALLBACKS not defined.\n"));
          return PS_ERROR;
        }
#endif //~ PTIS_SUPPORT_CODECALLBACKS
        if (k) { // not custom
#ifdef PTIS_SUPPORT_CODECALLBACKS
    ...
    return PS_OK;
#else
      ERROR_MSG(_T("Error: %") NPRIs _T(" specified, PTIS_SUPPORT_CODECALLBACKS not defined.\n"),  line.gettoken_str(0));
    return PS_ERROR;
#endif //~ PTIS_SUPPORT_CODECALLBACKS
#else
    case TOK_PAGE:
    ...
    case TOK_PAGEEXEND:
    case TOK_PAGECALLBACKS:
      ERROR_MSG(_T("Error: %") NPRIs _T(" specified, PTIS_CONFIG_VISIBLE_SUPPORT not defined.\n"),  line.gettoken_str(0));
    return PS_ERROR;
...
#ifdef PTIS_CONFIG_SILENT_SUPPORT
...
#else
    case TOK_CHECKBITMAP:
      ERROR_MSG(_T("Error: %") NPRIs _T(" specified, PTIS_CONFIG_COMPONENTPAGE not defined.\n"),  line.gettoken_str(0));
    return PS_ERROR;
    ...
    case TOK_INSTTYPE:
      {
        ...
        else
        {
          ...
          for (x = 0; x < PTIS_MAX_INST_TYPES && cur_header->install_types[x]; x++);
          if (x == PTIS_MAX_INST_TYPES)
          {
            ERROR_MSG(_T("InstType: no more than %d install types allowed. %d specified\n"), PTIS_MAX_INST_TYPES, PTIS_MAX_INST_TYPES + 1);
            return PS_ERROR;
          }
          else
          {
    ...
    case TOK_COMPTEXT:
    case TOK_INSTTYPE:
      ERROR_MSG(_T("Error: %") NPRIs _T(" specified but PTIS_CONFIG_COMPONENTPAGE not defined\n"),line.gettoken_str(0));
    return PS_ERROR;
#endif //~ PTIS_CONFIG_COMPONENTPAGE
    ...
    case TOK_LICENSEDATA:
    case TOK_LICENSEBKCOLOR:
      ERROR_MSG(_T("Error: %") NPRIs _T(" specified, PTIS_CONFIG_LICENSEPAGE not defined.\n"),  line.gettoken_str(0));
    return PS_ERROR;
#endif //~ PTIS_CONFIG_LICENSEPAGE
#ifdef PTIS_CONFIG_SILENT_SUPPORT
    case TOK_SILENTINST:
    {
      ...
      if (k == 2)
      {
        ERROR_MSG(_T("SilentInstall: silentlog specified, no log support compiled in (use PTIS_CONFIG_LOG)\n"));
        return PS_ERROR;
      }
#endif //~ PTIS_CONFIG_LOG
...
#ifdef PTIS_CONFIG_UNINSTALL_SUPPORT
    {
    ...
    return PS_OK;
#else
      ERROR_MSG(_T("Error: %") NPRIs _T(" specified, PTIS_CONFIG_UNINSTALL_SUPPORT not defined.\n"),  line.gettoken_str(0));
    return PS_ERROR;
#endif
    case TOK_IFSILENT:
    ...
    case TOK_IFSILENT:
    case TOK_SETSILENT:
      ERROR_MSG(_T("Error: %") NPRIs _T(" specified, PTIS_CONFIG_SILENT_SUPPORT not defined.\n"),  line.gettoken_str(0));
    return PS_ERROR;
#endif //~ PTIS_CONFIG_SILENT_SUPPORT
    case TOK_IFRTLLANG:
    ...
    case TOK_INSTPROGRESSFLAGS:
      {
        ...
        try {
          ...
          BYTE* dlg = res_editor->GetResource(RT_DIALOG, IDD_INSTFILES, PTIS_DEFAULT_LANG);
          ...
          DWORD dwSize;
          dlg = dt.Save(dwSize);
          res_editor->UpdateResource(RT_DIALOG, IDD_INSTFILES, PTIS_DEFAULT_LANG, dlg, dwSize);
...
#ifndef PTIS_CONFIG_UNINSTALL_SUPPORT
      ERROR_MSG(_T("Error: ShowUninstDetails specified but PTIS_CONFIG_UNINSTALL_SUPPORT not defined\n"));
      return PS_ERROR;
#endif
    ...
    return PS_OK;
    case TOK_BGFONT:
#ifndef PTIS_SUPPORT_BGBG
      ERROR_MSG(_T("Error: BGFont specified but PTIS_SUPPORT_BGBG not defined\n"));
      return PS_ERROR;
#else // PTIS_SUPPORT_BGBG
      if (line.getnumtokens()==1)
      {
    ...
    return PS_OK;
#endif //~ PTIS_SUPPORT_BGBG
    case TOK_BGGRADIENT:
#ifndef PTIS_SUPPORT_BGBG
      ERROR_MSG(_T("Error: BGGradient specified but PTIS_SUPPORT_BGBG not defined\n"));
      return PS_ERROR;
#else // PTIS_SUPPORT_BGBG
      if (line.getnumtokens()==1)
      {
...
#endif //~ PTIS_CONFIG_UNINSTALL_SUPPORT
#endif //~ PTIS_SUPPORT_BGBG
    return PS_OK;
#ifdef PTIS_CONFIG_VISIBLE_SUPPORT
    case TOK_INSTCOLORS:
    ...
    case TOK_CHANGEUI:
      try {
        ...
        #define SAVE(x) uire->FreeResource(dlg); dlg = UIDlg.Save(dwSize); res_editor->UpdateResource(RT_DIALOG, x, PTIS_DEFAULT_LANG, dlg, dwSize); UIDlg.FreeSavedTemplate(dlg);
    ...
    case TOK_ADDBRANDINGIMAGE:
      try {
        ...
        init_res_editor();
        BYTE* dlg = res_editor->GetResource(RT_DIALOG, IDD_INST, PTIS_DEFAULT_LANG);
        CDialogTemplate dt(dlg, build_unicode, uDefCodePage);
        res_editor->FreeResource(dlg);
        ...
        res_editor->UpdateResource(RT_DIALOG, IDD_INST, PTIS_DEFAULT_LANG, dlg, dwDlgSize);
        dt.FreeSavedTemplate(dlg);
    ...
    case TOK_PEADDRESOURCE:
    {
      ...
      if (rl == CResourceEditor::ANYLANGID)
        rl = exists ? foundrl : PTIS_DEFAULT_LANG;
    ...
    return PS_OK;
#else
      ERROR_MSG(_T("Error: %") NPRIs _T(" specified, PTIS_CONFIG_COMPRESSION_SUPPORT not defined.\n"),  line.gettoken_str(0));
    return PS_ERROR;
#endif //~ PTIS_CONFIG_COMPRESSION_SUPPORT
    case TOK_LOADNLF:
    {
    ...
    return add_entry(&ent);
#else //! PTIS_CONFIG_UNINSTALL_SUPPORT
    case TOK_WRITEUNINSTALLER:
    case TOK_UNINSTCAPTION:
    case TOK_UNINSTICON:
    case TOK_UNINSTTEXT:
    ...
    case TOK_SECTION:
    {
      ...
      {
        ERROR_MSG(_T("Error: Uninstall section declared, no PTIS_CONFIG_UNINSTALL_SUPPORT\n"));
        return PS_ERROR;
      }
#endif
    ...
    case TOK_SECTIONIN: // Legacy 1 based instruction
      {
        ...
        for (int ti = 0; ++ti < line.getnumtokens();)
        {
          ...
          else
          {
            ...
            if (succ && itid >= 0 && itid < PTIS_MAX_INST_TYPES)
            {
    ...
    case TOK_FUNCTION:
      ...
      if (!_tcsnicmp(line.gettoken_str(1),_T("un."),3))
      {
        ERROR_MSG(_T("Error: Uninstall function declared, no PTIS_CONFIG_UNINSTALL_SUPPORT\n"));
        return PS_ERROR;
      }
#endif
    ...
    return PS_OK;
#endif //~ PTIS_CONFIG_PLUGIN_SUPPORT
    ...
    return PS_OK;
#else
      ERROR_MSG(_T("Error: %") NPRIs _T(" specified, PTIS_SUPPORT_FILE not defined.\n"),  line.gettoken_str(0));
    return PS_ERROR;
#endif
        ...
        if (trim) try {
          ...
          if (trim) {
            ...
            if (line.getnumtokens()==a+1 && line.gettoken_str(a)[0])
              ...
              wsprintf(str, _T("Nullsoft Install System %") NPRIs, PTIS_VERSION);
          ...
          DWORD dwSize;
          dlg = td.Save(dwSize);
          res_editor->UpdateResource(RT_DIALOG, IDD_INST, PTIS_DEFAULT_LANG, dlg, dwSize);
    ...
    case TOK_CREATEDIR:
      {
        ...
        TCHAR out_path[PTIS_MAX_STRLEN], *p=line.gettoken_str(1);
    ...
    return add_entry(&ent);
#else
      ERROR_MSG(_T("Error: %") NPRIs _T(" specified, PTIS_SUPPORT_EXECUTE not defined.\n"),  line.gettoken_str(0));
    return PS_ERROR;
#endif //~ PTIS_SUPPORT_EXECUTE
    case TOK_EXECSHELL:
    case TOK_EXECSHELLWAIT:
#ifdef PTIS_SUPPORT_SHELLEXECUTE
    {
      UINT to=0, xflags=0;
    ...
    return add_entry(&ent);
#else
      ERROR_MSG(_T("Error: %") NPRIs _T(" specified, PTIS_SUPPORT_SHELLEXECUTE not defined.\n"),  line.gettoken_str(0));
    return PS_ERROR;
#endif //~ PTIS_SUPPORT_SHELLEXECUTE
    case TOK_CALLINSTDLL:
    case TOK_REGDLL:
    case TOK_UNREGDLL:
#ifndef PTIS_SUPPORT_ACTIVEXREG
      ERROR_MSG(_T("%") NPRIs _T(": support not compiled in (PTIS_SUPPORT_ACTIVEXREG)\n"),line.gettoken_str(0));
      return PS_ERROR;
#else // PTIS_SUPPORT_ACTIVEXREG
    ...
    return add_entry(&ent);
#endif //~ PTIS_SUPPORT_ACTIVEXREG
    case TOK_RENAME:
#ifdef PTIS_SUPPORT_RENAME
      {
        int a=1;
        ent.which=EW_RENAME;
        if (!_tcsicmp(line.gettoken_str(1),_T("/REBOOTOK")))
        {
          ent.offsets[2]=1;
          a++;
#ifndef PTIS_SUPPORT_MOVEONREBOOT
          ERROR_MSG(_T("Error: /REBOOTOK specified, PTIS_SUPPORT_MOVEONREBOOT not defined\n"));
          PRINTHELP()
#endif
        }
        else if (line.gettoken_str(1)[0]==_T('/'))
...
#ifdef PTIS_SUPPORT_MOVEONREBOOT
        DefineInnerLangString(NLF_RENAME_ON_REBOOT);
#endif
      }
    return add_entry(&ent);
#else
      ERROR_MSG(_T("Error: %") NPRIs _T(" specified, PTIS_SUPPORT_RENAME not defined.\n"),  line.gettoken_str(0));
    return PS_ERROR;
#endif //~ PTIS_SUPPORT_RENAME
    case TOK_MESSAGEBOX:
#ifdef PTIS_SUPPORT_MESSAGEBOX
      {
        #define MBD(x) {x,_T(#x)},
    ...
    return add_entry(&ent);
#else
      ERROR_MSG(_T("Error: %") NPRIs _T(" specified, PTIS_SUPPORT_MESSAGEBOX not defined.\n"),  line.gettoken_str(0));
    return PS_ERROR;
#endif //~ PTIS_SUPPORT_MESSAGEBOX
    case TOK_CREATESHORTCUT:
#ifdef PTIS_SUPPORT_CREATESHORTCUT
    {
    ...
    return add_entry(&ent);
#else
      ERROR_MSG(_T("Error: %") NPRIs _T(" specified, PTIS_SUPPORT_CREATESHORTCUT not defined.\n"),  line.gettoken_str(0));
    return PS_ERROR;
#endif //~ PTIS_SUPPORT_CREATESHORTCUT
#ifdef PTIS_SUPPORT_HWNDS
    case TOK_FINDWINDOW:
    ...
    case TOK_HIDEWINDOW:
    case TOK_ENABLEWINDOW:
      ERROR_MSG(_T("Error: %") NPRIs _T(" specified, PTIS_CONFIG_ENHANCEDUI_SUPPORT not defined.\n"),  line.gettoken_str(0));
    return PS_ERROR;
#endif //~ PTIS_CONFIG_ENHANCEDUI_SUPPORT
#else //! PTIS_SUPPORT_HWNDS
    case TOK_ISWINDOW:
    case TOK_SENDMESSAGE:
    case TOK_FINDWINDOW:
    case TOK_GETDLGITEM:
    ...
    case TOK_HIDEWINDOW:
    case TOK_BRINGTOFRONT:
      ERROR_MSG(_T("Error: %") NPRIs _T(" specified, PTIS_SUPPORT_HWNDS not defined.\n"),  line.gettoken_str(0));
    return PS_ERROR;
#endif //~ PTIS_SUPPORT_HWNDS
    case TOK_DELETE:
#ifdef PTIS_SUPPORT_DELETE
      {
        int a=1;
    ...
    return add_entry(&ent);
#else
      ERROR_MSG(_T("Error: %") NPRIs _T(" specified, PTIS_SUPPORT_DELETE not defined.\n"),  line.gettoken_str(0));
    return PS_ERROR;
#endif //~ PTIS_SUPPORT_DELETE
    case TOK_RMDIR:
#ifdef PTIS_SUPPORT_RMDIR
      {
        int a=1;
        ent.which=EW_RMDIR;
    ...
    return add_entry(&ent);
#else
      ERROR_MSG(_T("Error: %") NPRIs _T(" specified, PTIS_SUPPORT_RMDIR not defined.\n"),  line.gettoken_str(0));
    return PS_ERROR;
#endif //~ PTIS_SUPPORT_RMDIR
...
#ifdef PTIS_SUPPORT_FILE
      {
        ...
        while (a < line.getnumtokens())
        {
          ...
          if (reserveplugin && get_file_name(t)==t)
          {
            ...
            {
              pluginfullpath = definedlist.find(_T("PTISDIR"));
    ...
    return PS_OK;
      ...
      ERROR_MSG(_T("Error: %") NPRIs _T(" specified, PTIS_SUPPORT_FILE not defined.\n"),  line.gettoken_str(0));
    return PS_ERROR;
#endif //~ PTIS_SUPPORT_FILE
#ifdef PTIS_SUPPORT_COPYFILES
    case TOK_COPYFILES:
      {
...
#else
    case TOK_COPYFILES:
      ERROR_MSG(_T("Error: %") NPRIs _T(" specified, PTIS_SUPPORT_COPYFILES not defined.\n"),  line.gettoken_str(0));
    return PS_ERROR;
#endif //~ PTIS_SUPPORT_COPYFILES
    ...
    case TOK_STRCMP:
    case TOK_STRCMPS:
      ERROR_MSG(_T("Error: %") NPRIs _T(" specified, PTIS_SUPPORT_STROPTS not defined.\n"),  line.gettoken_str(0));
    return PS_ERROR;
#endif //~ PTIS_SUPPORT_STROPTS
#ifdef PTIS_SUPPORT_INIFILES
    ...
    case TOK_WRITEINISTR:
    case TOK_READINISTR:
      ERROR_MSG(_T("Error: %") NPRIs _T(" specified, PTIS_SUPPORT_INIFILES not defined.\n"),  line.gettoken_str(0));
    return PS_ERROR;
#endif //~ PTIS_SUPPORT_INIFILES
    ...
    case TOK_GETFULLPATHNAME:
    case TOK_GETKNOWNFOLDERPATH:
      ERROR_MSG(_T("Error: %") NPRIs _T(" specified, PTIS_SUPPORT_FNUTIL not defined.\n"),  line.gettoken_str(0));
      return PS_ERROR;
#endif //~ PTIS_SUPPORT_FNUTIL
    ...
    return add_entry(&ent);
#else
      ERROR_MSG(_T("Error: %") NPRIs _T(" specified, PTIS_SUPPORT_GETDLLVERSION not defined.\n"),  line.gettoken_str(0));
      return PS_ERROR;
#endif //~ PTIS_SUPPORT_GETDLLVERSION
    case TOK_GETFILETIME:
#ifdef PTIS_SUPPORT_GETFILETIME
    ...
    return add_entry(&ent);
#else
      ERROR_MSG(_T("Error: %") NPRIs _T(" specified, PTIS_SUPPORT_GETFILETIME not defined.\n"),  line.gettoken_str(0));
      return PS_ERROR;
#endif //~ PTIS_SUPPORT_GETFILETIME
#ifdef PTIS_SUPPORT_INTOPTS
    ...
    case TOK_INTFMT: case TOK_INT64FMT:
    case TOK_INTCMP: case TOK_INTCMPU: case TOK_INT64CMP: case TOK_INT64CMPU: case TOK_INTPTRCMP: case TOK_INTPTRCMPU:
      ERROR_MSG(_T("Error: %") NPRIs _T(" specified, PTIS_SUPPORT_INTOPTS not defined.\n"),  line.gettoken_str(0));
      return PS_ERROR;
#endif //~ PTIS_SUPPORT_INTOPTS
#ifdef PTIS_SUPPORT_REGISTRYFUNCTIONS
    case TOK_READREGSTR:
    ...
    case TOK_ENUMREGKEY:
    case TOK_ENUMREGVAL:
      ERROR_MSG(_T("Error: %") NPRIs _T(" specified, PTIS_SUPPORT_REGISTRYFUNCTIONS not defined.\n"),  line.gettoken_str(0));
      return PS_ERROR;
#endif //~ PTIS_SUPPORT_REGISTRYFUNCTIONS
#ifdef PTIS_SUPPORT_STACK
    case TOK_EXCH:
      {
        int swapitem=1;
    ...
    case TOK_PUSH:
    case TOK_EXCH:
      ERROR_MSG(_T("Error: %") NPRIs _T(" specified, PTIS_SUPPORT_STACK not defined.\n"),  line.gettoken_str(0));
    return PS_ERROR;
#endif //~ PTIS_SUPPORT_STACK
#ifdef PTIS_SUPPORT_ENVIRONMENT
    case TOK_READENVSTR:
      ent.which=EW_READENVSTR;
      ent.offsets[0]=GetUserVarIndex(line, 1);
      {
        TCHAR str[PTIS_MAX_STRLEN];
        _tcscpy(str, _T("%"));
    ...
    case TOK_EXPANDENVSTRS:
    case TOK_READENVSTR:
      ERROR_MSG(_T("Error: %") NPRIs _T(" specified, PTIS_SUPPORT_ENVIRONMENT not defined.\n"),  line.gettoken_str(0));
    return PS_ERROR;
#endif //~ PTIS_SUPPORT_ENVIRONMENT
#ifdef PTIS_SUPPORT_FINDFIRST
    case TOK_FINDFIRST:
    ...
    case TOK_FINDNEXT:
    case TOK_FINDFIRST:
      ERROR_MSG(_T("Error: %") NPRIs _T(" specified, PTIS_SUPPORT_FINDFIRST not defined.\n"),  line.gettoken_str(0));
    return PS_ERROR;
#endif //~ PTIS_SUPPORT_FINDFIRST
#ifdef PTIS_SUPPORT_FILEFUNCTIONS
    case TOK_FILEOPEN:
      {
        ent.which=EW_FOPEN;
    ...
    case TOK_FILEREAD:
      ...
      if (line.gettoken_str(3)[0])
        ...
        ent.offsets[2]=add_intstring(PTIS_MAX_STRLEN-1);
      if (ent.offsets[0]<0 || ent.offsets[1]<0) PRINTHELP()
    ...
    case TOK_FILEWRITEWORD:
#endif
      ERROR_MSG(_T("Error: %") NPRIs _T(" specified, PTIS_SUPPORT_FILEFUNCTIONS not defined.\n"),  line.gettoken_str(0));
    return PS_ERROR;
#endif //~ PTIS_SUPPORT_FILEFUNCTIONS
#ifdef PTIS_SUPPORT_REBOOT
    case TOK_REBOOT:
    {
    ...
    case TOK_IFREBOOTFLAG:
    case TOK_SETREBOOTFLAG:
      ERROR_MSG(_T("Error: %") NPRIs _T(" specified, PTIS_SUPPORT_REBOOT not defined.\n"),  line.gettoken_str(0));
    return PS_ERROR;
#endif //~ PTIS_SUPPORT_REBOOT
#ifdef PTIS_CONFIG_LOG
    case TOK_LOGSET:
      ent.which=EW_LOG;
      ent.offsets[0]=1;
    ...
    case TOK_LOGSET:
    case TOK_LOGTEXT:
      ERROR_MSG(_T("Error: %") NPRIs _T(" specified, PTIS_CONFIG_LOG not defined.\n"),  line.gettoken_str(0));
    return PS_ERROR;
#endif //~ PTIS_CONFIG_LOG
#ifdef PTIS_CONFIG_COMPONENTPAGE
    ...
    return PS_OK;
#ifdef PTIS_SUPPORT_VERSION_INFO
    case TOK_VI_ADDKEY:
    {
      LANGID LangID=0;
      int a = 1;
    ...
    case TOK_VI_SETPRODUCTVERSION:
    case TOK_VI_SETFILEVERSION:
      ERROR_MSG(_T("Error: %") NPRIs _T(" specified, PTIS_SUPPORT_VERSION_INFO not defined.\n"),line.gettoken_str(0));
      return PS_ERROR;
#endif //~ PTIS_SUPPORT_VERSION_INFO
    case TOK_LOCKWINDOW:
#ifdef PTIS_LOCKWINDOW_SUPPORT
    ...
    return add_entry(&ent);
#else
      ERROR_MSG(_T("Error: %") NPRIs _T(" specified, PTIS_LOCKWINDOW_SUPPORT not defined.\n"),line.gettoken_str(0));
    return PS_ERROR;
#endif //~ PTIS_LOCKWINDOW_SUPPORT
    ...
    case TOK__PLUGINCOMMAND:
    case TOK_INITPLUGINSDIR:
      ERROR_MSG(_T("Error: %") NPRIs _T(" specified, PTIS_CONFIG_PLUGIN_SUPPORT not defined.\n"),line.gettoken_str(0));
    return PS_ERROR;
#endif //~ PTIS_CONFIG_PLUGIN_SUPPORT
