...
// Modified by Ori Peleg for use in PTIS, to reduce the required Boost includes
...
public:
    ...
    explicit scoped_ptr(typename PTIS::CXX::stdsmartptr<T>::type p): ptr(p.release()) // never throws
    {
    }
