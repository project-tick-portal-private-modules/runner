...
- [x] Every public API function has a dedicated page in the
  [API reference documentation](https://json.projecttick.org/api/basic_json/) with a self-contained code example.
...
- [x] The test suite is executed with enabled [runtime assertions](https://json.projecttick.org/features/assertions/) to
...
- [x] All library options are exposed as [CMake options](https://json.projecttick.org/integration/cmake/) and tested.
